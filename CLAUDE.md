...
<structure>
  src/app/          â€” Expo Router file-based routes (src/app/_layout.tsx is root). Add new screens to this folder.
  src/components/   â€” Reusable UI components. Add new components to this folder.
  src/lib/          â€” Utilities: cn.ts (className merge), example-context.ts (state pattern)
</structure>
...
<typescript>
  ...
  Include ALL required properties when creating objects â€” TypeScript strict mode is enabled.
</typescript>
...
<routing>
  ...
  <tabs_router>
    ...
    At least 2 tabs or don't use tabs at all â€” single tab looks bad.
  </tabs_router>
  
  <router_selection>
    Games should avoid tabs â€” use full-screen stacks instead.
  ...
  <rules>
    Only ONE route can map to "/" â€” can't have both src/app/index.tsx and src/app/(tabs)/index.tsx.
...
<state>
  ...
  Reuse query keys across components to share cached data â€” don't create duplicate providers.
...
<design>
  Don't hold back. This is mobile â€” design for touch, thumb zones, glanceability.
...
<mistakes>
  ...
  <react_native>
    No Node.js buffer in React Native â€” don't import from 'buffer'.
  </react_native>
